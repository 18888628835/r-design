...
const Svg_color: Story<SvgProps> = (args) => {
    ...
    return <>
        <SVG svgName='icon-qianjin' style={{color:'red',marginRight:'10px'}} />
        <SVG svgName='icon-qianjin' style={{color:'green',marginRight:'10px'}} />
...
const Svg_size: Story<SvgProps> = (args) => {
    return <>
        <SVG svgName='icon-qianjin' style={{fontSize:'20px',marginRight:'10px'}}/>
